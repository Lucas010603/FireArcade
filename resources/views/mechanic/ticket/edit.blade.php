    ...
    <div class="container">
        ...
        @endif
            ...
            <div class="mb-3">
                ...
                <select disabled name="customer_id" id="customer_id" class="form-select" data-error-message="Selecteer een klant">
                    ...
                    @foreach($customer as $customers)
                        @if($ticket->customer && $ticket->customer->id == $customers->id)
            ...
            <div class="mb-3">
                ...
                <a class="btn btn-success" onclick="finnishTicket({{ $ticket->id }})">Afronden</a>
                @endif
                @if($ticket->status_id == 1 || $ticket->status_id == 2)
        ...
        @if(count($errors))
            <div id="form-submit-fail" class="alert alert-danger" role="alert">
                Ticket bewerken mislukt. probeer het nog eens.
            </div>
        @endif
    </div>
